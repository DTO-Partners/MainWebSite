...
import { MapPin, Phone, Mail, Building, FileText, Shield, Globe, Linkedin, Twitter } from "lucide-react"

export default function Footer() {
  // Company headquarters coordinates - Jana Heweliusza 11, Gdańsk, Poland
  const headquarters = {
    lat: 54.3520,
    lng: 18.6466,
    address: "ul. Jana Heweliusza 11 lok. 811",
    city: "80-890 Gdańsk",
    country: "Poland"
  }
  ...
  const googleMapsEmbedUrl = `https://www.google.com/maps/embed/v1/place?key=${import.meta.env.VITE_GOOGLE_MAPS_API_KEY || 'AIzaSyAS-mahT6bTQ-IEdTYkQpSv8ZhtqLfGSmE'}&q=${encodeURIComponent(`${headquarters.address}, ${headquarters.city}, ${headquarters.country}`)}&zoom=15`
  ...
  return (
    <footer className="bg-gradient-to-br from-[#1a1a2e] via-[#16213e] to-[#1a1a2e] text-white relative overflow-hidden">
      {/* Background Pattern */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[600px]">
          ...
          >
            ...
            <iframe
              ...
              title="DTO Partners Headquarters Location"
            />
              ...
              >
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-[#1a1a2e] font-bold text-lg mb-1">Headquarters</h3>
                    <p className="text-[#1a1a2e]/80 text-sm leading-relaxed">
                      {headquarters.address}<br />
                      {headquarters.city}<br />
          ...
          >
            ...
            <div className="mb-8">
              ...
              >
                <h2 className="text-4xl font-light text-white mb-4">
                  DTO <span className="font-bold text-[#daa520]">Partners</span>
                </h2>
                ...
                <p className="text-white/80 leading-relaxed max-w-md">
                  ...
                  Connecting exceptional talent with visionary organizations across global markets.
                </p>
              </motion.div>
            </div>
            ...
            <div className="space-y-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 xl:grid-cols-2 gap-4">
                  {contactInfo.map((contact, _) => (
                    ...
                    >
                      ...
                      <div>
                        <p className="text-xs text-white/60 uppercase tracking-wider">{contact.label}</p>
              ...
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <h3 className="text-white font-semibold mb-4 text-lg">Phone Numbers</h3>
              ...
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <h3 className="text-white font-semibold mb-4 text-lg">Company Registration</h3>
        ...
        >
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="text-white/60 text-sm">
              © {new Date().getFullYear()} DTO Partners Sp. z o.o. All rights reserved.
            </div>
            <div className="flex items-center gap-6 text-sm">
              <a href="#" className="text-white/60 hover:text-[#daa520] transition-colors duration-300">
                Privacy Policy
              </a>
              <a href="#" className="text-white/60 hover:text-[#daa520] transition-colors duration-300">
                Terms of Service
