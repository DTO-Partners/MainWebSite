    ...
    >
      ...
      <div className="w-full flex flex-col lg:flex-row min-h-[60vh] lg:h-1/2 relative z-10">
        ...
        <div className="w-full lg:w-1/2 px-6 md:px-8 lg:px-12 py-12 md:py-16 lg:py-24 space-y-6 lg:space-y-8 flex flex-col justify-center relative group">
          ...
          <div className="absolute bottom-16 md:bottom-32 right-16 md:right-32 w-12 md:w-16 h-12 md:h-16 bg-gradient-to-tr from-[#daa520]/20 to-transparent rounded-full blur-xl animate-pulse" style={{ animationDelay: '1.5s' }}></div>
          ...
          <div className="space-y-4 relative z-10">
            <div className="w-16 md:w-20 h-16 md:h-20 rounded-2xl md:rounded-3xl bg-gradient-to-br from-[#daa520] via-[#b8860b] to-[#daa520] flex items-center justify-center shadow-2xl shadow-[#daa520]/40 mb-4 md:mb-6 relative overflow-hidden group/icon mx-auto lg:mx-0">
              ...
              <span className="text-2xl md:text-3xl relative z-10 group-hover/icon:scale-110 transition-transform duration-300">🏢</span>
          ...
          <div className="relative z-10 flex justify-center lg:justify-start">
            <span className="inline-flex items-center gap-3 uppercase text-xs md:text-sm tracking-widest text-[#1a1a2e] font-semibold bg-gradient-to-r from-[#fff7d4]/80 via-white/70 to-[#fff7d4]/80 backdrop-blur-md px-6 md:px-10 py-4 md:py-5 rounded-full border-2 border-[#daa520]/40 shadow-xl hover:shadow-2xl hover:border-[#daa520]/60 transition-all duration-500 transform hover:scale-105 relative overflow-hidden group/badge">
              ...
              <span className="relative z-10 text-center">International Recruitment Company</span>
        ...
        <div className="w-full lg:w-1/2 min-h-[50vh] lg:min-h-full flex relative overflow-hidden group mt-8 lg:mt-0">
          ...
          <div className="absolute bottom-1/3 right-1/3 w-16 md:w-24 h-16 md:h-24 bg-gradient-to-tl from-[#fff7d4]/40 to-transparent rounded-full blur-2xl animate-pulse z-5" style={{ animationDelay: '1s' }}></div>
          <div className="absolute top-2/3 left-1/6 w-12 md:w-16 h-12 md:h-16 bg-gradient-to-r from-[#b8860b]/30 to-transparent rounded-full blur-xl animate-pulse z-5" style={{ animationDelay: '2s' }}></div>
          ...
          <div className="absolute top-4 md:top-8 left-4 md:left-8 z-20">
            <div className="flex flex-col gap-1 md:gap-2">
              ...
              <div className="w-1.5 md:w-2 h-1.5 md:h-2 bg-[#b8860b] rounded-full animate-pulse" style={{ animationDelay: '0.5s' }}></div>
          ...
          <div className="absolute bottom-4 md:bottom-8 left-4 md:left-8 z-20">
            <div className="flex gap-1">
              ...
              <div className="w-0.5 md:w-1 h-4 md:h-6 bg-[#b8860b]/60 rounded-full animate-pulse" style={{ animationDelay: '0.3s' }}></div>
              <div className="w-0.5 md:w-1 h-3 md:h-4 bg-[#daa520]/60 rounded-full animate-pulse" style={{ animationDelay: '0.6s' }}></div>
            </div>
          </div>
          ...
          <div className="absolute bottom-4 md:bottom-8 right-4 md:right-8 bg-white/10 backdrop-blur-2xl rounded-2xl md:rounded-3xl px-4 md:px-8 py-3 md:py-6 shadow-2xl border border-white/20 z-20 transform hover:scale-105 hover:-translate-y-1 md:hover:-translate-y-2 transition-all duration-500 group-hover:bg-white/20">
            <div className="flex items-center gap-2 md:gap-4">
              ...
              <div>
                <p className="text-xs md:text-sm font-bold text-white mb-1 tracking-wide">Smart Video</p>
                <p className="text-xs text-white/80 leading-relaxed hidden md:block">Auto-switches with<br />language selection</p>
                <p className="text-xs text-white/80 leading-relaxed md:hidden">Auto-switches</p>
              </div>
            </div>
        ...
        <div className="max-w-7xl lg:max-w-8xl mx-auto w-full relative z-10">
          ...
          <div className="text-center mb-12 md:mb-16">
            <div className="inline-flex items-center gap-2 md:gap-3 bg-gradient-to-r from-[#fff7d4]/60 via-white/80 to-[#fff7d4]/60 backdrop-blur-md px-6 md:px-8 py-2 md:py-3 rounded-full border border-[#daa520]/30 shadow-lg mb-4 md:mb-6">
              ...
              <span className="text-xs md:text-sm font-semibold text-[#1a1a2e] tracking-wider uppercase">Our Expertise</span>
            </div>
            <h3 className="text-2xl md:text-3xl lg:text-4xl font-light text-[#1a1a2e] mb-3 md:mb-4">Global Reach, Local Excellence</h3>
                ...
                {industries.map((item, index) => (
                  ...
                  >
                    ...
                    <div className="relative flex items-center gap-4 md:gap-6">
                      ...
                      >
                        <span className="text-xl md:text-2xl group-hover/item:scale-110 transition-transform duration-300">{item.icon}</span>
                      </div>
                ...
                {languages.map((lang, index) => (
                  ...
                  >
                    ...
                    <div className="relative flex items-center gap-4 md:gap-6">
                      ...
                      >
                        <span className="text-xl md:text-2xl group-hover/lang:scale-110 transition-transform duration-300">{lang.icon}</span>
                      </div>
